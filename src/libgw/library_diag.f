...
c
     ...
     x       ortr(igh),orti(igh)
      double precision si,sr,ti,tr,xi,xr,
     x       xdr,xdi,yi,yr,zzi,zzr,norm,tst1,tst2,
     x       pythag
c
c     this subroutine is a translation of a unitary analogue of the
...
c     .......... form shift ..........
 300       if (l .eq. en) go to 660
      ...
      zzr = -zzr
      zzi = -zzi
 310   call cdiv(xr,xi,yr+zzr,yi+zzi,xdr,xdi)
      xr = xdr
      xi = xdi
      sr = sr - xr
      si = si - xi
...
C                EIGENVALUE AFTER 30 ITERATIONS ..........
 ...
 1001 RETURN
      ...
      FUNCTION d_sign(A,B)
      double precision A,B,d_sign
      IF (B.GE.0.0D0) GOTO 10
      d_sign= - DABS(A)
      RETURN
 10   d_sign=DABS(A)
      RETURN
