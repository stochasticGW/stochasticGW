...
!                                                   
!                                                   
subroutine cnvrt_number_to_string_20(i,fr)
  implicit none
  character(len=20) :: fr
  integer i
  ...
  select case(i)
     ...
     case default; write(6,*)' problem with i in cnvrt_number_to_string_20, = ',i; stop
  end select

end subroutine cnvrt_number_to_string_20
