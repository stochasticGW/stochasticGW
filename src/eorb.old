...
subroutine calc_eorb
  use gwm, only : n, dv,  eorb, vks, trace, orb_rd, read_eorb
  ...
  rnk0 : if(rank==0) then
     ...
     write(6,*)' <phi|H|phi> from orbital in orb.txt is: ',real(eorb_calc)
     write(6,*)'                       vs. eorb as read: ',real(eorb)
     if(abs(eorb-eorb_calc)>0.02) &
          write(6,*)' WARNNING: a big difference between eorb(as was read) and <phi|H|phi> '
